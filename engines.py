...
def build_blueprint(
    ...
    blueprint = {
        ...
        'summary': {
            ...
            'incarnation_cross': hd_chart['incarnation_cross']['name'],
            'incarnation_cross_gates': f"{hd_chart['incarnation_cross']['conscious_sun']}/{hd_chart['incarnation_cross']['conscious_earth']} | {hd_chart['incarnation_cross']['unconscious_sun']}/{hd_chart['incarnation_cross']['unconscious_earth']}",
